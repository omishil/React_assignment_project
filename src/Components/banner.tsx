...
export default function Banner() {
  return (
    ...
    <div className="  text-black w-[600px] flex flex-col gap-[40px]">
      <h1 className=" font-bold text-[60px] ">Build Your Ideal <br />
<span className="fon bg-gradient-to-r from-[#EC3950] via-[#D81B7E] to-[#7C3AED] bg-clip-text text-transparent">
 Development Stack
</span>        </h1>
      <p>
      ...
      <button className="border border-gray-400 rounded-[10px] px-4 py-2">Learn more</button>
      </div>
    </div>
